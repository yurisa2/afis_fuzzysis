...
data <- read.csv("dias_horas_90.csv")
...
colnames(data_per_day)[6]
# accuracy_fis(data_per_day,data_input,n_col_features,nbin)
#
data_per_day[,idx]
idx <- 13
colnames(data_per_day)[idx]
bx_values(data_per_day, n_col_features[idx],nbin)
boxplot(data_per_day[,idx]~data_per_day[,nbin])
